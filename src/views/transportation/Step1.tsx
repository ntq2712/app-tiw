...
const CreateTransStep1: FC<TCreateOtherOrder> = props => {
  const {step, des, setDes} = props

  const {setSelectedFrom, setSelectedTo, selectedFrom, selectedTo} = props
        ...
        <>
          ...
          {isProd && (
            <View style={{width: '100%', backgroundColor: '#fff', marginTop: 8, padding: 16}}>
              ...
              <View style={[styles.wrapInput, {marginTop: 16, paddingHorizontal: 4}]}>
                <TheInput defaultValue={des} onBlur={text => setDes(text)} placeholder="Ghi chú" />
              </View>
            </View>
          )}
        </>
...
export default CreateTransStep1
